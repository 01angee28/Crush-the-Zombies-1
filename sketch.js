...
var stones = [];
var stone;
var axeImg,bkImg,stoneImg,woodImg,zombieImg;

function preload (){
  zombieImg = loadimage("./Project 33 assests./assets./zombie.png");
  bkImg = loadimage("./Project 33 assests./assets./background.png");
